		...
		nav_container.waypoint({
			handler: function(direction) {
				if (direction == 'down') {
					...
					//name.stop().addClass("active").css("top",-name.outerHeight()).animate({"top":top_spacing});
					...
					//name.stop().removeClass("active").css("top",name.outerHeight()+waypoint_offset).animate({"top":""});
			...
			offset: function() {
				...
				return -name.outerHeight()-waypoint_offset;
			}
		});
